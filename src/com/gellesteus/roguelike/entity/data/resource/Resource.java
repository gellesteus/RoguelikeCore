...
public class Resource implements Update{
	public static final Resource HEALTH = new Resource("Health",0,1);
	public static final Resource MANA = new Resource("Mana",0,1);
	public static final Resource STAMINA = new Resource("Stamina",0,5);
	public static final Resource BLOOD = new Resource("Blood",0,0);
	public static final Resource MIND_POINTS = new Resource("Mind Points",0,1);
	public static final Resource DIVINE_ENERGY = new Resource("Divine Energy",-100,0);
	public static final Resource COMBO_POINt = new Resource("Combo Position",0,0);
	public static final Resource SHIELD = new Resource("Shield",0,-5);
	public static final Resource AIFEAR = new Resource("AI Fear State Controller",0,-1);
	...
	private Resource(String name,int min,int regen){
		this.min=min;
		this.name=name;
